...
// "&operator=" operatöründe & işareti olmasada normal olarak çalışıyor. 
...
Static fonksiyonlar program başladığında otomatik olarak oluşturuluyor bu sayede Fixed::max gibi bir fonksiyon çağırdığımızda constructor ve destructor işlemini yapmaya gerek kalmıyor.
*/
